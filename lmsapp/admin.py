...
class PaymentAdmin(admin.ModelAdmin):
    ...
    def get_course(self, payment):
        return format_html(f"<a target='_blank' href='/admin/lmsapp/course/{payment.course.id}'>{payment.course}</a>")
...
class UserCourseAdminModel(admin.ModelAdmin):
    ...
    def get_course(self, usercourse):
        return format_html(f"<a target='_blank' href='/admin/lmsapp/course/{usercourse.course.id}'>{usercourse.course}</a>")
